...
$navigation = [
	[
		"label" => "Dashboard",
		"href" => "/danceclub/admin",
		"is_active" => $_SERVER['REQUEST_URI'] === "/danceclub/admin/"
	], 
	[
		"label" => "Articles",
		"href" => "/danceclub/admin/articles/",
		"is_active" => $_SERVER["REQUEST_URI"] === "/danceclub/admin/articles/"
	], 
	[
		"label" => "Utilisateurs",
		"href" => "/danceclub/admin/users/",
		"is_active" => $_SERVER["REQUEST_URI"] === "/danceclub/admin/users/"
	]
];
?>
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    <a href="/danceclub/index.php" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                        Retour au site
                    </a>
                </div>
            </div>
